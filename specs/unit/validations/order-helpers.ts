import {
  PlaceOrderRequestValidationObject,
  OrderItemValidationObject
} from "../../../shared/validation/place-order-request-validator";
...
export function createValidOrder(
  ...
  return {
    ...
    deliveryAddress: isDeliveryAddressRequired({
      deliveryMethod,
      paymentMethod
    })
      ? createValidDeliveryAddress()
      : null,
    billingAddress: isBillingAddressRequired({ paymentMethod })
      ? createValidDeliveryAddress()
      : null,
    deliveryMethod: deliveryMethod,
