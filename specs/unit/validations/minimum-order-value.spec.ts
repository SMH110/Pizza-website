  ...
  it("When the total amount spent on pizza is less than 10 - Should return the expected results", () => {
    let testCases: TestCase[] = [
      ...
      },
      {
        ...
        paymentMethod: "Credit / Debit Card",
        expectedErrors: [
          "A minimum spend of £9.99 is required on pizza or calzone for Credit / Debit Card orders."
        ]
      },
      {
        deliveryMethod: "Collection",
        paymentMethod: "PayPal",
        expectedErrors: [
          "A minimum spend of £9.99 is required on pizza or calzone for PayPal orders."
        ]
      }
    ];
