...
export class UserDetailsService {
    ...
    private save() {
        sessionStorage.setItem(STORAGE_KEY, JSON.stringify({
            ...
            billingAddressSameAsDeliveryAddress: this.billingAddressSameAsDeliveryAddress
        }));
    }
    ...
    private load() {
        ...
        if (userDetails && userDetails.billingAddressSameAsDeliveryAddress) {
            this._billingAddressSameAsDeliveryAddress = userDetails.billingAddressSameAsDeliveryAddress;
        }
    }
