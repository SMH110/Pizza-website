...
if (!process.env.PORT) {
  ...
  process.env.PASSPORT_SECRET =
    "";

  process.env.CONNECTION_STRING =
    "mongodb+srv://godfather-pizza-qa:QPXX6x540zuy2h47p8Ze6lEAK2b1M7YX@qa.qewmz.mongodb.net/qa?retryReads=true&retryWrites=true&w=majority";
  ...
  process.env.PAYPAL_CLIENT_ID =
    "AWIevBHnu9162GxBPIu9kqyNU-EB2YItx6jF6fEqQrRlqZ9I9G49tNePR_4q0IMJCRPw3XYUZbMrLEjx";
  process.env.PAYPAL_SECRET =
    "EHFGmfZjwI5n70O9Uo73MEIIyzd0hv3mGEo0NyErBEeNXJfXOyiwa57NN4gPrQ9HA5L7EmphXyU7Vr9r";
  ...
  process.env.BARCLAYS_EPDQ_SHA_IN =
    "m770110578nOy80vxnqN558T69V9711788hzhxCfK8348sMRa8e98180214606yQ";
