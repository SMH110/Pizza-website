...
export const _extraLargePizzaSideAndCanDeal: DiscountRule = {
    name: 'Any Extra Large pizza, a side and a optional can of drink for £16.99',
    description: 'Any Extra Large pizza, a side and a optional can of drink for £16.99',
    calculate(basket: DiscountCalculationDto) {
        ...
        return sum(pizzas.slice(0, timesToApply)) + sum(sides.slice(0, timesToApply)) + sum(cans.slice(0, timesToApply)) - (timesToApply * 15.99);
    }
}
